...
//import com.example.demo.member.adapter.out.persistence.MemberCommandAdapter;
...
//import com.example.demo.member.adapter.out.persistence.MemberQueryAdapter;
...
//        Member member = memberQueryAdapter.findById(board.getMember().getId());
